...
function HeaderContent({ mobileOpen, servicesOpen, menuId, isActive, onClose, onMenuToggle, onServicesToggle }: HeaderContentProps) {
  return (
    <div className="container">
      <div className="header__wrap ul_li_between">
        <div className="xb-header-logo">
          <Link href="/" className="logo" aria-label="Always Compliant home"><img src="/assets/img/always-compliant/always-compliant-logo-white.svg" alt="Always Compliant" /></Link>
        </div>
        ...
        <div className="xb-header-btn d-lg-block d-none">
          <Link className="thm-btn thm-btn--gradient2" data-split-link="" aria-label="Book Consultation" href="/contact">
            <div className="inner"><div className="text" data-link-shadow="">Book Consultation</div><div className="arrow"><img src="/assets/img/icon/sms-icon02.svg" alt="" /></div></div>
      ...
      <div className="xb-header-wrap">
        <div className={`xb-header-menu${mobileOpen ? " active" : ""}`} id={menuId} aria-hidden={!mobileOpen}>
          <div className="xb-header-menu-scroll">
            ...
            <div className="xb-logo-mobile xb-hide-xl"><Link href="/" rel="home" onClick={onClose}><img src="/assets/img/always-compliant/always-compliant-logo.svg" alt="Always Compliant" /></Link></div>
...
export function SiteHeader({ legacyBehavior = false }: { legacyBehavior?: boolean }) {
  ...
  return (
    <header id="xb-header-area" className="header-area header-area--three header-transparent is-sticky">
      <div className={`xb-header stricky${legacyBehavior ? "" : " original"}`}><HeaderContent {...sharedProps} menuId="ac-mobile-nav" /></div>
