...
export const metadata: Metadata = { title: "Compliance Insights", description: "Practical guidance on GST, ROC, tax, registrations and business compliance.", alternates: { canonical: "/insights" } };
...
export default function InsightsPage() {
  return <PageShell>
    ...
    <section className="ac-section ac-insight-note"><div className="container"><div className="ac-note-card"><Image src="/assets/img/always-compliant/always-compliant-expertise-documents.svg" alt="A compliance checklist with filing status indicators" width={401} height={179} /><div><span className="ac-eyebrow">A PRACTICAL REMINDER</span><h2>Good compliance starts before the form is opened.</h2><p>Confirm the obligation, due date, document owner and review step early. Requirements can vary by entity and filing profile, so seek advice for your specific circumstances.</p></div></div></div></section>
